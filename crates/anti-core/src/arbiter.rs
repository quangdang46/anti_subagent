...
mod tests {
    ...
    fn arbiter_scores_by_rubric_deterministically() {
        ...
        let mut opts = vec![
            ArbiterOption {
                id: "fast".into(),
                desc: "quick hack".into(),
                risk: Risk::High,
                effort: Effort::Small,
            },
            ArbiterOption {
                id: "solid".into(),
                desc: "proper fix".into(),
                risk: Risk::Low,
                effort: Effort::Large,
            },
        ];
        ...
        assert!(
            ranked.iter().position(|o| o.id == "solid").unwrap()
                < ranked.iter().position(|o| o.id == "fast").unwrap()
        );
    }
    ...
    fn arbiter_cannot_mutate_fs() {
        ...
        let a = Arbiter;
        let ranked = a.rank(&mut vec![ArbiterOption {
            id: "x".into(),
            desc: "d".into(),
            risk: Risk::Low,
            effort: Effort::Small,
